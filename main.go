...
func deleteMovie(w http.ResponseWriter, r *http.Request) {
	...
	json.NewEncoder(w).Encode(movies)
	//no need of return statement as it is the last statement of the function so it will automatically return
}
...
func createMovie(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application-json")
	var movie Movie
	_ = json.NewDecoder(r.Body).Decode(&movie)//it will decode the json data and store it in movie
